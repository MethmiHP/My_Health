...
// // // ✅ Only one App() definition remains
// // export default function App() {
// //   return (
// //     <AuthProvider>
// //       <Router>
...
//         {/* Reports Routes - Accessible by admin */}
//         <Route
//           path="/reports"
//           element={
//             <ProtectedRoute roles={['admin']}>
...
//         <Route path="/dashboard/hospital" element={<Navigate to="/admin-dashboard" replace />} />
...
// =======
//         {/* Appointments (patient, reception, admin) */}
//         <Route
//           path="/appointments"
//           element={
//             <ProtectedRoute roles={['patient', 'reception', 'admin']}>
...
//           }
//         />
// >>>>>>> 5bbca6d1ee38f577a7fd1f364f75539d78c45115
  ...
  return (
    <>
      ...
      <Routes>
        ...
        {/* Confirmation page (left public as in your first file) */}
        <Route path="/appointments/confirmed" element={<AppointmentConfirmed />} />

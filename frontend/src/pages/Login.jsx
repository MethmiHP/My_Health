...
//         navigate(goByRole(res.role), { replace: true });
//       } else {
...
//             Access appointments, electronic records, billing, and more across our connected hospital network.
//           </p>

//           <ul className="mt-6 space-y-2 text-sm text-teal-900/80">
//             <li>• Doctors: manage schedules & view patient lists</li>
//             <li>• Patients: book visits & review lab results</li>
//             <li>• Admin/Reception: oversee operations & billing</li>
//           </ul>
//         </div>
...
//               <p className="text-sm text-teal-900/70">Please sign in to continue</p>
//             </div>
...
//                   <span className="bg-white/90 px-2 text-xs text-teal-700">Don’t have an account?</span>
//                 </div>
//               </div>
...
//                 <Link to="/register" className="text-xs text-teal-700 hover:text-teal-800">

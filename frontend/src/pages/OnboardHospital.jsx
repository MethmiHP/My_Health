...
// // import heroImg from "../assets/hospital.jpg";  // background (optional)
// // import logo from "../assets/logo2.jpg";        // brand logo (optional)
...
// //   // Basic validations
// //   const validate = () => {
// //     if (!hospital.name || !hospital.code) {
// //       return "Hospital name and code are required.";
// //     }
// //     if (!/^[A-Z0-9-]{2,10}$/.test(hospital.code)) {
// //       return "Hospital code must be 2-10 characters (A-Z, 0-9, -).";
// //     }
// //     if (!admin.firstName || !admin.lastName) {
// //       return "Admin first and last name are required.";
// //     }
...
// //     }
// //     if (!agree) {
// //       return "Please confirm you’re authorized to onboard this hospital.";
// //     }
// //     return null;
// //   };
...
// //       // If you want to auto-login using data.token, you can store it here and redirect:
...
// //             Create your hospital in SmartCare. The first account becomes the <b>Hospital Admin</b>
// //             —you can add doctors, reception, cashier, and patients afterward.
// //           </p>
...
// //           <form
// //             onSubmit={onSubmit}
// //             className="rounded-3xl bg-white/90 border border-teal-100 shadow-lg p-6 sm:p-8 space-y-7"
// //           >
// //             <div className="flex items-center gap-3">
...
//   // Use your Vite env (restart Vite after editing .env)
//   const API = import.meta.env.VITE_API_BASE_URL || "http://localhost:5000";
...
//       // try to parse response (even for non-2xx)
//       let data = {};
//       try {
//         data = await res.json();
//       } catch {

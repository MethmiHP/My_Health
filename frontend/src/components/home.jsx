...
// //       {/* Custom CSS for animations (works in CRA/Vite). If you use Next.js styled-jsx, add the jsx attribute. */}
// //       <style>{`
// //         @keyframes fadeUp {
...
// //                 <h3 className="font-semibold">Hospital Network</h3>
// //               </div>
...
// //                   </div>
// //                   <span className="ml-3 text-xl font-bold">SMARTCARE</span>
// //                 </div>
...
// //                   <div><a href="#" className="text-teal-200 hover:text-white">Support</a></div>
// //                 </div>
// //               </div>
